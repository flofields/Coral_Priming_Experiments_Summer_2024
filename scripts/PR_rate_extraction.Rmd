...
write.csv(Photo, file="data/Photo_Rawextracted_rates.csv")
write.csv(Resp, file="data/Resp_Rawextracted_rates.csv")
```
...
# Visualize data
pdf("output/Raw_Resp.pdf", width=6, height=6)
...
# Visualize data
pdf("output/Raw_Photo.pdf", width=6, height=6)
